...
### Create List
curl --location --request POST '127.0.0.1:8080/createlist' --header 'Content-Type: application/json' --data '{ "TodoListName": "Shopping" }'
...
### Add Item
curl --location --request POST '127.0.0.1:8080/additem' --header 'Content-Type: application/json' --data '{
...
curl --location --request PATCH '127.0.0.1:8080/updateitemdescription'
...
### Update Item Status
curl --location --request PATCH '127.0.0.1:8080/updateitemstatus'
--header 'Content-Type: application/json'
--data '{
    "TodoListName": "Shopping",
    "ItemName": "Item1",
